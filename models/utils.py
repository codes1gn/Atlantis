...
# Value is shape dict
WORKLOADS_DIC = {
    "resnet_block": {bs: {"input0": [bs, 112, 112, 8]} for bs in range(1, 129)},
    "resnet50": {bs: {"input0": [bs, 64, 56, 56]} for bs in range(1, 129)},
    "resnext50_32x4d": {bs: {"input0": [bs, 64, 56, 56]} for bs in range(1, 129)},
    "nasneta": {bs: {"input0": [bs, 64, 56, 56]} for bs in range(1, 129)},
    ...
    "nasrnn": {bs: {"x.1": [bs, 2560]} for bs in range(1, 129)},
    "bert": {bs: {"input0": [bs, 1024]} for bs in range(1, 129)},
    "bert_full": {bs: {"input0": [bs, 64, 256]} for bs in range(1, 129)},
    "resnet50_3d": {bs: {"input0": [bs, 64, 3, 56, 56]} for bs in range(1, 129)},
    "mobilenetV2": {bs: {"input0": [bs, 32, 224, 224]} for bs in range(1, 129)},
    "dcgan": {bs: {"input0": [bs, 100]} for bs in range(1, 129)},
    "yolov3": {bs: {"input0": [bs, 3, 416, 416]} for bs in range(1, 129)},
    "gpt2": {bs: {"input0": [bs, 1024]} for bs in range(1, 129)},
    "squeezenet": {bs: {"input0": [bs, 3, 224, 224]} for bs in range(1, 129)},
    "vit": {bs: {"input0": [bs, 3, 224, 224]} for bs in range(1, 129)},
    "shufflenetV2": {bs: {"input0": [bs, 3, 224, 224]} for bs in range(1, 129)},
}
